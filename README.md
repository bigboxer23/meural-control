...
Supported sources include <b>OpenAI TextCompletion -> gpt-image-1.5</b>, <b>OpenAI ChatGPT -> gpt-image-1.5</b>, a <b>Google Photos Album</b>,
...
This source allows using OpenAI's gpt-image-1.5 text to image generator to create custom images to display on the frame from a
